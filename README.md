...
```sh
  cd my-folder
  git clone https://github.com/MPDADDY/rsndom_quote_machine.git
```
...
Feel free to check the [issues page](https://github.com/MPDADDY/rsndom_quote_machine/issues).
